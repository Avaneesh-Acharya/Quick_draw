...
r=Math.floor(Math.random()*quick_draw_data_set.length)
console.log(quick_draw_data_set[r])
document.getElementById("Sketch_Draw").innerHTML="Sketch to be Drawn: "+quick_draw_data_set[r]
timer_counter=0
timer_check=""
draw_sketch=""
answer=""
